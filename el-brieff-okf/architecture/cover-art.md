...
description: Portada canónica actual del podcast El Brieff usada en plataformas y como ancla visual del sitio.
...
| Uso actual | Portada del podcast en plataformas; referencia de marca para el sitio |
...
2. Preferir el asset completo en OG / share cards / hero de marca.
3. Colores de UI derivados de este asset (ver `DESIGN.md`); no reintroducir tertiary rojo ni accent azul genérico previos.
4. Si se regenera la portada, actualizar este concepto, `DESIGN.md` y el `log.md` del OKF.
